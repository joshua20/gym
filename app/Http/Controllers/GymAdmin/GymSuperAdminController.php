...
class GymSuperAdminController extends GymAdminBaseController
{
    ...
    public function showDashboard()
    {
        ...
        $this->data['manageMenu'] = '';
        $this->data['customerMenu'] = '';
        $this->data['attendanceMenu'] = ''; 
        $this->data['gymMenu'] = '';
        $this->data['enuriryMenu'] = '';
        $this->data['messageMenu'] = '';
        $this->data['targetMenu'] = '';
        $this->data['subscriptionMenu'] = '';
        $this->data['membershipMenu'] = '';
        $this->data['taskMenu'] = '';
        $this->data['paymentMenu'] = '';
        $this->data['account'] = '';
        $this->data['showpaymentMenu'] = '';
        $this->data['title'] = 'Super Admin';
        $this->data['paymentreminderMenu'] = '';
        $this->data['paymentreminderHistoryMenu'] = '';
        $this->data['invoiceMenu'] = '';
        $this->data['expenseMenu'] = '';
        $this->data['reportMenu'] = '';
        $this->data['targetreportMenu'] = '';
        $this->data['clientreportMenu'] = '';
        $this->data['financialreportMenu'] = '';
        $this->data['attendancereportMenu'] = '';
        $this->data['enquiryreportMenu'] = '';
        $this->data['balancereportMenu'] = '';
        $this->data['promotionMenu'] = '';
        $this->data['promotionEmailMenu'] = '';
        $this->data['promotionDbMenu'] = '';
        $this->data['updatesMenu'] = '';
    ...
    {
        $branches = Common::query()
            ->select('common_details.id', 'common_details.title')
            ->leftJoin('business_branches', 'business_branches.detail_id', '=', 'common_details.id');

        return DataTables::of($branches)
            ->addColumn('actions', function ($row) {
                return view('partials.branch-actions', ['row' => $row]);
            })
            ->rawColumns(['actions'])
            ->removeColumn('id')
            ->make(true);
